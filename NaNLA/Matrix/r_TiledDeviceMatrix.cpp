...
namespace NaNLA {
    ...
    r_TiledDeviceMatrix<NumericType, TiledController, Controller, TileDetails>::r_TiledDeviceMatrix(uint64_t rows,
                                                                                                uint64_t cols,
                                                                                                uint64_t tileSize) :
            Internal::r_AbstractDeviceMatrix<NumericType, TiledController <NumericType, Controller, TileDetails>>(rows, cols, tileSize) {
        ;
    }
    ...
    template<class NumericType, template<class, template<class> class,
            ...
            template<class> class Controller,
            template<class> class TileDetails>
    auto r_TiledDeviceMatrix<NumericType, TiledController, Controller, TileDetails>::getTileSize() const -> uint64_t {
    ...
    template<class NumericType, template<class, template<class> class,
            ...
            template<class> class Controller,
            template<class> class TileDetails>
    auto constexpr r_TiledDeviceMatrix<NumericType, TiledController, Controller, TileDetails>::getTileMajor() -> bool {
    ...
    template<class NumericType, template<class, template<class> class,
            ...
            template<class> class Controller,
            template<class> class TileDetails>
    auto  r_TiledDeviceMatrix<NumericType, TiledController, Controller, TileDetails>::getTileRows() const -> uint64_t {
    ...
    template<class NumericType, template<class, template<class> class,
            ...
            template<class> class Controller,
            template<class> class TileDetails>
    auto  r_TiledDeviceMatrix<NumericType, TiledController, Controller, TileDetails>::getTileCols() const -> uint64_t {
    ...
    template<class rNumericType,
            ...
            class... Args>
    r_TiledDeviceMatrix<rNumericType, rTiledController, rController, rTileDetails>
            r_TiledDeviceMatrix<NumericType, TiledController, Controller, TileDetails>::add(
                    const r_TiledDeviceMatrix<RhsNumericType, RhsTiledController, RhsController, RhsTileDetails > rhs,
                        Args... args) const {
        if constexpr (sizeof...(args) > 1) {
            ...
            r_TiledDeviceMatrix <rNumericType, rTiledController, rController, rTileDetails> rMatrix(
    ...
    template<class rNumericType,
            ...
            template<class> class RhsController,
            template<class> class RhsTileDetails>
    void r_TiledDeviceMatrix<NumericType, TiledController, Controller, TileDetails>::add(
            const r_TiledDeviceMatrix<RhsNumericType, RhsTiledController, RhsController, RhsTileDetails > rhs,
...
template<class rNumericType,
        ...
        template<class> class RhsController,
        template<class> class RhsTileDetails>
void r_TiledDeviceMatrix<NumericType, TiledController, Controller, TileDetails>::cudaDot(
        const r_TiledDeviceMatrix<RhsNumericType, RhsTiledController, RhsController, RhsTileDetails > rhs,
        r_TiledDeviceMatrix<rNumericType, rTiledController, rController, rTileDetails > rMatrix) const {
