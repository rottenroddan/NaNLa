...
namespace NaNLA::MemoryControllers {
    ...
    class r_TiledDeviceMemoryController : virtual public AbstractTileMemoryController<NumericType, Controller, TileDetails>,
...
#include "r_TiledDeviceMemoryController.cpp"
