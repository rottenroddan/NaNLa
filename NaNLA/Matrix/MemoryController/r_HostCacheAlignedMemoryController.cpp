...
namespace NaNLA::MemoryControllers {
    ...
    r_HostCacheAlignedMemoryController<NumericType>::r_HostCacheAlignedMemoryController(uint64_t rows, uint64_t cols,
    ...
    template<class NumericType>
    r_HostCacheAlignedMemoryController<NumericType>::r_HostCacheAlignedMemoryController(uint64_t rows, uint64_t cols) :
            r_HostCacheAlignedMemoryController<NumericType>(rows, cols,
