...
namespace NaNLA {
    ...
    class r_TiledHostMatrix : public Internal::AbstractHostMatrix<NumericType, TiledController<NumericType, Controller, TileDetails>> {
    public:
        using DataType = NumericType;

        r_TiledHostMatrix(uint64_t rows, uint64_t cols, uint64_t tileSize);
        ...
        template<class rNumericType = NumericType,
                ...
                class... Args>
        r_TiledHostMatrix<rNumericType, rTiledController, rController, rTileDetails> add(const r_TiledHostMatrix<RhsNumericType, RhsTiledController, RhsController, RhsTileDetails > rhs,
                                                                                         Args... args) const;
        ...
        template<class rNumericType = NumericType,
                ...
                template<class> class RhsController,
                template<class> class RhsTileDetails>
        void add(const r_TiledHostMatrix<RhsNumericType, RhsTiledController, RhsController, RhsTileDetails > rhs,
        ...
        template<class rNumericType = NumericType,
                ...
                template<class> class RhsController,
                template<class> class RhsTileDetails>
        void dot(const r_TiledHostMatrix<RhsNumericType, RhsTiledController, RhsController, RhsTileDetails > rhs,
                 r_TiledHostMatrix<rNumericType, rTiledController, rController, rTileDetails > resultMatrix) const;
    };
